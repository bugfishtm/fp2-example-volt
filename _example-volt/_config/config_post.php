<?php
	...
	*/ if(!is_array($object)) { http_response_code(404); Header("Location: ../"); exit(); }
	...
	#####################################################################################
		...
		$sub[1]["nav_loc"] 	= hive_get_url_rel(array("first_loc", "login", false)); # Location
		...
		$sub[1]["nav_act"] = "login";	   # Show as Active in Nav on Which Second Location?
		...
		$object["nav"][5]["nav_title"] = $object["lang"]->translate("nav_sub_buttons"); # Nav Name
		...
		$object["nav"][5]["nav_loc"] = hive_get_url_rel(array("buttons", false, false)); # Location
		...
		$object["nav"][5]["nav_img"] = "bx bx-table"; # Box Icon Image Class
		...
		$object["nav"][5]["nav_act"] = "buttons";	# Show as Active in Nav on Which First Location?
