...
# Volt Example Integration

This module demonstrates how to use the fast-php-page CMS Functions to fast Deploy a Volt Dashboard Page! You can find the repository of the CMS itself here: https://github.com/bugfishtm/fast-php-page.
